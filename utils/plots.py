...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        cv2.rectangle(img, (c1[0], c1[1] + t_size[1] + 3), c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(img, label, (c1[0], c1[1] + t_size[1] + 3), 0, tl / 3, [0, 0, 0], thickness=tf, lineType=cv2.LINE_AA)
