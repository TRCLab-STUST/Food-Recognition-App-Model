...
class LoadImages:  # for inference
    def __init__(self, path, img_size=512, stride=32):
...
class LoadWebcam:  # for inference
    def __init__(self, pipe='0', img_size=512, stride=32):
        self.img_size = img_size
        self.stride = stride
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=512, batch_size=12, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.mosaic = self.augment and not self.rect  # Mosaic 數據增強將同時加載4個圖片並進行合併
